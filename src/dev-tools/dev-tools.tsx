...
function EnableDevTools() {
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => setEnableDevTools(event.target.checked)
...
function RequestMinTime() {
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => setMinTime(Number(event.target.value))
...
function RequestVarTime() {
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => setVarTime(Number(event.target.value))
